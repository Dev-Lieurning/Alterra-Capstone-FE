...
const Footer = () => {
  return (
    <Container>
      <Left>
        <Logo>Meet Chamber</Logo>
        <Desc>Meet Chamber, the next things you must remember</Desc>
        <SocialContainer>
      ...
      <Center>
        ...
        <List>
          ...
          <ListItem>Jakarta</ListItem>
          <ListItem>Bandung</ListItem>
          <ListItem>Bali</ListItem>
          <ListItem>About us</ListItem>
          <ListItem>Be Our Partner</ListItem>
          <ListItem>Trivia</ListItem>
